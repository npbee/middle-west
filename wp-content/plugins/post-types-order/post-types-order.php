...
class Post_Types_Order_Walker extends Walker 
    {
        ...
        function start_el(&$output, $page, $depth = 0, $args = array(), $id = 0) {
            ...
            $_displayInCarousel = get_field('show_in_carousel', $page->ID);
            $displayInCarousel = $_displayInCarousel ? ' :: Displaying in Carousel ' : '';
            $output .= $indent . '<li id="item_'.$page->ID.'"><span>'.apply_filters( 'the_title', $page->post_title, $page->ID ).'<em>'. $displayInCarousel .'</em></span>';
        }
